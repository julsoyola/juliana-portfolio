...
export default function Navigation() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[var(--forest)]/10 bg-[var(--paper)]/90 px-5 py-4 backdrop-blur-md lg:px-10">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        <a
          href="#top"
          className="font-display flex items-center gap-2 text-xl font-semibold text-[var(--forest)] sm:text-2xl"
        >
        ...
        <button
          ...
          className="rounded-full border border-[var(--forest)]/30 bg-[var(--paper)] px-4 py-2 text-sm font-semibold text-[var(--forest)] md:hidden"
